...
RUN pip install --no-cache-dir modal==0.73.100 httpx tqdm websocket-client boto3==1.35.92 supabase flask cupy-cuda12x redis Pillow waitress onnxruntime-gpu 
